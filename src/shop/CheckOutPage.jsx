        ...
        <div className='modalCard'>
            ...
            >
                <div className="modal-dialog">
                    <h5 className='px-3 mb-3 text-center'>
                            ...
                            <div className="tabs mt-3">
                                <ul className='nav nav-tabs'
                                    ...
                                    <li className='nav-item' role='presentation'>
                                        <a href="#visa" id='visa-tab' data-toggle="tab" role='tab'
                                    ...
                                    <li className='nav-item' role='presentation'>
                                        <a href="#paypal" id='paypal-tab' data-toggle="tab" role='tab'
                                ...
                                {/* payment desc */}
                                <p className='mt-3 px-4 p-Disclaimer'><em>Payment Disclamer : </em> In no event shall 
                                payment or partial payment by Owner for any material
                                or service</p>
                            </div>
                        </div>
                    </div>
